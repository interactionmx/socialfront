  ...
  return (
    <Page title="Profile Screen">
      <h2>
        ...
        {appState.loggedIn && !state.profileData.isFollowing && appState.user.username != state.profileData.profileUsername && state.profileData.profileUsername && state.profileData.profileUsername != '...' && (
